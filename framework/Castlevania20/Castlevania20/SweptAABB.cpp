...
bool Swept::AABBCheck(Box b1, Box b2)
{
	return !(b1.x + b1.w < b2.x || b1.x > b2.x + b2.w || b1.y + b1.h < b2.y || b1.y > b2.y + b2.h);
}

bool Swept::AABB(Box b1, Box b2, float& moveX, float& moveY)
{
	moveX = moveY = 0.0f;
...
Box Swept::GetSweptBroadphaseBox(Box b)
{
...
float Swept::SweptAABB(Box b1, Box b2, float& normalx, float& normaly)
{
